        ...
        <div className='topbar-one'>
          <div className='container'>
            <div className='topbar-one__left'>
              <a href='/'>
                <img width='250' src='/assets/images/logo-1-1.png' alt='' />
              </a>
            </div>
            <div className='topbar-one__right'>
              <div className='topbar-one__info'>
                ...
                <div className='topbar-one__content'>
                  <h3>
                    <a href='mailto:jerome.fullstack@gmail.com'>
                      jerome.fullstack@gmail.com
                    </a>
                  </h3>
                  <p>Send Email</p>
                </div>
            ...
            <div className='container'>
              <div className='inner-container'>
                ...
                <div className='main-nav__right'>
                  <a href='prevention.html' className='thm-btn main-nav__btn'>
                    Prevention
                  </a>
                </div>
              </div>
